...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_RollEffect = 100f;             // The strength of effect for roll input.
        [SerializeField] private float m_PitchEffect = 100f;            // The strength of effect for pitch input.
        [SerializeField] private float m_YawEffect = 100f;            // The strength of effect for yaw input.
