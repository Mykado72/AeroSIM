...
public class PlaneParticleEffect : MonoBehaviour
{
    ...
    public PlaneControleur m_Jet; // The jet that the particle effect is attached to
    ...
    private PlaneControleur FindAeroplaneParent()
    {
        ...
        while (t != null)
        {
            var aero = t.GetComponent<PlaneControleur>();
            if (aero == null)
            {
                // try next parent
                t = t.parent;
